...
It simulates two and a half million seasons as it starts. Every simulated
season is rated with the full Massey model and put through the committee
rules, so this takes a while, around twenty minutes on a 16-core machine. That one run answers
